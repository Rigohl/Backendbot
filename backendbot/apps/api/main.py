...
Construido con FastAPI para alto rendimiento y documentación automática.

Endpoints principales:
- /api/v1/health - Health checks
- /api/v1/bots/* - Gestión de bots
- /api/v1/system/* - Información del sistema
- /api/v1/config/* - Gestión de configuración
- /api/v1/ui/* - Datos para la interfaz
- /api/v1/notifications/* - Gestión de notificaciones
- /api/v1/power/* - Gestión de energía
- /api/v1/backup/* - Gestión de backups
...
app = FastAPI(
    ...
    description="API Gateway para BackendBot - Sistema de monitoreo y gestión",
    version="0.1.0",
    docs_url="/docs",
    redoc_url="/redoc",
)
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://127.0.0.1", "http://localhost"],  # Solo localhost
...
def authenticate_user(username: str, password: str):
    ...
    if username == "admin" and password == "backendbot_secure_2024":
...
async def root(request: Request):
    ...
    """
    # Mensaje ajustado para compatibilidad con tests existentes
    return {
        "message": "BackendBot API Gateway - Welcome to BackendBot Orchestrator",
        "version": "0.1.0",
        "docs": "/docs",
