...
from backendbot.modes import mode_manager
from backendbot.modes.adaptive_learning import adaptive_learning
        ...
        while self.running:
            try:
                ...
                if gpu_available and gpus:
                    ...
                    if gpu.memoryTotal > 0:
                        vram_percent = (gpu.memoryUsed / gpu.memoryTotal) * 100
                        adaptive_learning.record_performance_metric(
                            "gpu_memory_usage", vram_percent
                        )
