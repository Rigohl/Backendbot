...
class ChatPanel(QtWidgets.QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.add_message(
            "BackendBot",
            "¡Hola! Soy BackendBot, tu asistente de escritorio. Escribe 'help' para ver comandos disponibles.",
        )
    ...
    def add_message(self, sender: str, message: str):
        ...
        try:
            ...
            # Log del mensaje
            self.logger.debug(
                f"Mensaje agregado: {sender}: {message[:50]}...", "ChatPanel"
            )
    ...
    def _process_command(self, command: str) -> str:
        ...
        try:
            ...
            self.data_repo.save_system_event(
                level="ERROR", source="ChatPanel", message=error_msg, details=str(e)
            )
