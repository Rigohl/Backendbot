...
from src.backendbot.cron_jobs.task_integration import task_integration

import logging
import traceback

def main():
    logging.basicConfig(filename="backendbot_error.log", level=logging.ERROR,
    ...
    try:
        ...
        ui.panel.show_message(f"Modo inicial: {mode_info['mode'].capitalize()} - {mode_info['description']}")
        ...
        msg.setText("Ocurrió un error crítico. Revisa backendbot_error.log para más detalles.")
