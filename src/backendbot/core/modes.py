...
class BaseModeStrategy(ABC):
    ...
    def __init__(self, mode_name: str, focus_processes: list):
...
class DesarrolloModeStrategy(BaseModeStrategy):
    ...
    def apply_configurations(self, manager):
        ...
        self.logger.info("Aplicando configuraciones de modo Desarrollo", "DesarrolloMode")
...
class OperationModeManager:
    ...
    def __init__(self):
        ...
        self.logger.info(f"OperationModeManager inicializado en modo: {self.current_mode.mode_name}", "ModeManager")
