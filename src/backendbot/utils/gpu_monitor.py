...
class GPUInfo:
    ...
    def __init__(self, id, name="Unknown GPU", memory_total=0, memory_used=0, memory_free=0, temperature=0):
        self.id = id
        self.name = name
...
def getGPUs():
    ...
    try:
        ...
        try:
            ...
            pynvml.nvmlShutdown()
            logger.info(f"nvidia-ml-py funcionó correctamente - {len(gpus)} GPUs encontradas")
            return gpus
    ...
    if not gpus:
        ...
        gpus.append(GPUInfo(id=0, name="GPU No Detectada", memory_total=0, memory_used=0, memory_free=0, temperature=0))
