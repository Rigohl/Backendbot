...
class AdvancedCommandProcessor:
    ...
    def process_command(self, command: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if recognized_command:
                ...
                adaptive_learning.record_user_action('natural_command', {
                ...
                response_text = self._process_recognized_command(recognized_command, params)
                result = {
    ...
    def _recognize_pattern(self, command: str) -> Tuple[Optional[str], Dict[str, Any]]:
        ...
        for command_type, patterns in self.command_patterns.items():
            for pattern in patterns:
                ...
                if match:
                    params = {}
                    if command_type in ['task_enable', 'task_disable'] and len(match.groups()) > 0:
    ...
    def _process_recognized_command(self, command_type: str, params: Dict[str, Any]) -> str:
        """Procesar comando reconocido"""
        try:
            ...
            return random.choice(self.response_templates['error_response']).format(error=str(e))
    ...
    def _process_task_management(self) -> str:
        ...
        try:
            from src.backendbot.core.task_scheduler import task_scheduler
    ...
    def _process_basic_command(self, command: str) -> Optional[str]:
